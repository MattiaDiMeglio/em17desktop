...
/**
 * Questa classe rappresenta la view corrispondente al grafico {@link javafx.scene.chart.PieChart
 * PieChart}. L'aggiornamento della view è eseguita secondo i canoni del design pattern MVC.
 *
 * @author ingsw20
 */
public class PieChartView implements Observer, ChartInterface {
  ...
  /**
   * il construttore inizializza {@link #pieChart} per la gestione del grafico, inoltre registra la
  ...
  public PieChartView(PieChart pieChart, ComboBox dashboardYearComboBox2) {
    ...
    dashboardYearComboBox2.valueProperty()
  ...
  public void update(Observable o, Object arg) {
    if (o instanceof PieChartModel) {
      ...
      Double ticketsPerc =
          (Double.valueOf(eventModel.getTicketSold()) / Double.valueOf(eventModel.getMaxVisitors()))
              * 100;
      updateChart(ticketsPerc);
    } else {
