...
/**
 * La classe rappresenta il model utile alla view per i grafici presente in {@link
 * view.EventListView EventListView}. La comunicazione tra il model e le rispettive view avviene
...
public class MergedModel extends Observable {
  ...
  /**
   * il metodo si occupa di resettare tutti i dati nel model così da essere riempito con i nuovi
   * dati.
   */
