...
/**
 * La classe rappresenta il model utile alla view relativa al grafico di tipo {@link javafx.scene.chart.LineChart Linechart}
 * oppure di tipo {@link javafx.scene.chart.StackedAreaChart StackedAreaChart}. La comunicazione tra il model e
 * le rispettive view avviene secondo i canoni del design pattern MVC
 *
 * @author ingSW20
 */
