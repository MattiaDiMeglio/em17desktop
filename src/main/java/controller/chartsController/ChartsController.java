...
public class ChartsController {
    ...
    private ExecutorService chartsThread = Executors.newSingleThreadExecutor();
    ...
    private void startExecutors(DataSnapshot snapshot, String year){
        chartsThread.execute(new Thread(() -> {
